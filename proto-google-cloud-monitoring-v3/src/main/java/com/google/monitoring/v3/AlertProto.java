  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "obuf/wrappers.proto\032\027google/rpc/status.proto\"\343\027\n"
          ...
          + " \001(\0132/.google.monitoring.v3.AlertPolicy.AlertStrategy\0323\n\r"
          ...
          + "\023condition_threshold\030\001 \001(\0132;.google.monit"
          + "oring.v3.AlertPolicy.Condition.MetricThresholdH\000\022U\n"
          + "\020condition_absent\030\002 \001(\01329.goo"
          + "gle.monitoring.v3.AlertPolicy.Condition.MetricAbsenceH\000\022U\n"
          + "\025condition_matched_log\030\024"
          + " \001(\01324.google.monitoring.v3.AlertPolicy.Condition.LogMatchH\000\022{\n"
          + "#condition_monitoring_query_language\030\023 \001(\0132L.google.mon"
          + "itoring.v3.AlertPolicy.Condition.MonitoringQueryLanguageConditionH\000\0325\n"
          + "\007Trigger\022\017\n"
          ...
          + "\007trigger\030\007"
          + " \001(\01323.google.monitoring.v3.AlertPolicy.Condition.Trigger\032\320\001\n\r"
          ...
          + "le.monitoring.v3.AlertPolicy.Condition.Trigger\032\274\001\n"
          + "\010LogMatch\022\023\n"
          + "\006filter\030\001 \001(\tB\003\340A\002\022c\n"
          + "\020label_extractors\030\002 \003(\0132I.google.moni"
          + "toring.v3.AlertPolicy.Condition.LogMatch.LabelExtractorsEntry\0326\n"
          ...
          + ".monitoring.v3.AlertPolicy.Condition.Trigger:\227\002\352A\223\002\n"
          + ".monitoring.googleapis.com/AlertPolicyCondition\022Fprojects/{project}/"
          + "alertPolicies/{alert_policy}/conditions/{condition}\022Porganizations/{organization"
          + "}/alertPolicies/{alert_policy}/conditions/{condition}\022Dfolders/{folder}/alertPol"
          + "icies/{alert_policy}/conditions/{condition}\022\001*B\013\n"
          + "\tcondition\032\352\001\n\r"
          + "AlertStrategy\022f\n"
          + "\027notification_rate_limit\030\001 \001(\0132E.google."
          + "monitoring.v3.AlertPolicy.AlertStrategy.NotificationRateLimit\022-\n\n"
          ...
          + "%monitoring.googleapis.com/AlertPolicy\022/projects/{project}/alertPo"
          + "licies/{alert_policy}\0229organizations/{organization}/alertPolicies/{alert_policy}"
          + "\022-folders/{folder}/alertPolicies/{alert_policy}\022\001*B\302\001\n"
          ...
          + "d\\Monitoring\\V3\352\002\035Google::Cloud::Monitoring::V3b\006proto3"
    };
    descriptor =
