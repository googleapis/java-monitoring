  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "resource.proto\032\031google/api/resource.proto\032\036google/protobuf/duration.proto\"\346\001\n"
          ...
          + " \001(\01325.google.monitoring.v3.UptimeCheckConfig.ResourceGroupH\000\022G\n\n"
          + "http_check\030\005"
          ...
          + "\003(\01326.google.monitoring.v3.UptimeCheckConfig.ContentMatcher\022A\n"
          ...
          + " \003(\0132%.google.monitoring.v3.InternalCheckerB\002\030\001\032a\n\r"
          + "ResourceGroup\022\020\n"
          + "\010group_id\030\001 \001(\t\022>\n\r"
          + "resource_type\030\002 \001(\0162"
          + "\'.google.monitoring.v3.GroupResourceType\032\250\005\n"
          + "\tHttpCheck\022W\n"
          + "\016request_method\030\010 \001(\0162?"
          + ".google.monitoring.v3.UptimeCheckConfig.HttpCheck.RequestMethod\022\017\n"
          + "\007use_ssl\030\001 \001(\010\022\014\n"
          + "\004path\030\002 \001(\t\022\014\n"
          + "\004port\030\003 \001(\005\022X\n"
          + "\tauth_info\030\004 \001(\0132E.google.monitoring.v3.UptimeChe"
          + "ckConfig.HttpCheck.BasicAuthentication\022\024\n"
          + "\014mask_headers\030\005 \001(\010\022O\n"
          + "\007headers\030\006 \003(\0132>."
          + "google.monitoring.v3.UptimeCheckConfig.HttpCheck.HeadersEntry\022S\n"
          + "\014content_type\030\t "
          + "\001(\0162=.google.monitoring.v3.UptimeCheckConfig.HttpCheck.ContentType\022\024\n"
          ...
          + "\013URL_ENCODED\020\001\032\030\n"
          + "\010TcpCheck\022\014\n"
          + "\004port\030\001 \001(\005\032\230\002\n"
          + "\016ContentMatcher\022\017\n"
          + "\007content\030\001 \001(\t\022\\\n"
          + "\007matcher\030\002 \001(\0162K.google.monitoring.v3.UptimeCheckCon"
          + "fig.ContentMatcher.ContentMatcherOption\"\226\001\n"
          ...
          + "igs/{uptime_check_config}\022Eorganizations/{organization}/uptimeCheckConfigs/{upti"
          + "me_check_config}\0229folders/{folder}/uptimeCheckConfigs/{uptime_check_config}\022\001*B\n"
          + "\n"
          + "\010resourceB\024\n"
          ...
          + "\030com.google.monitoring.v3B\013UptimeProtoP\001Z>google.golang."
          + "org/genproto/googleapis/monitoring/v3;mo"
          + "nitoring\252\002\032Google.Cloud.Monitoring.V3\312\002\032"
          + "Google\\Cloud\\Monitoring\\V3\352\002\035Google::Cloud::Monitoring::V3b\006proto3"
    };
    descriptor =
